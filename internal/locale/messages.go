...
var enMessages = map[string]string{
	...
	"tui.prlist.title":  "Submissions · %s",
	"tui.prlist.titleWithLogin": "Submissions · %s · %s",
	"tui.prlist.hint":   "        tab: focus cycle  ←/→: change filter  ↑/↓: scroll table",
	"tui.prlist.filterAll":  "All",
	"tui.prlist.col.repo":   "Repo",
	"tui.prlist.col.pr":     "ID",
	"tui.prlist.col.title":  "Title",
	"tui.prlist.col.author": "Author",
	"tui.prlist.col.date":   "Merged At",
	"tui.prlist.col.lines":  "Lines",
	"tui.prlist.empty":      "No submissions found for this period.",

	"tui.mergedPrTrend":   "code submission trend",
	"tui.mergedNReposFmt": "code submission trend for %d selected repos",
	"tui.repoPrTrend":     "%s  code submission trend",
	"tui.trend.contributorHeader":  "Contributors (↑↓) [. focus]:",
	"tui.trend.selectPersonHint":   "Select a contributor to see their submission chart",
	"tui.trend.personTitle":        "%s  code submission trend",
	"tui.bar.topPrCount":            "Submissions on top",
	"tui.barchart.pr":              "Item",
...
var zhMessages = map[string]string{
	...
	"tui.mergedPrTrend":   "代码交付趋势 (PR+直推)",
	"tui.mergedNReposFmt": "已选 %d 个仓库 代码交付趋势",
	"tui.repoPrTrend":     "%s  代码交付趋势",
	"tui.trend.contributorHeader":  "贡献者 (↑↓) [. 焦点]:",
	"tui.trend.selectPersonHint":   "选择贡献者后显示个人柱状图",
	"tui.trend.personTitle":        "%s  代码交付趋势",
	"tui.bar.topPrCount":            "交付数量",
	"tui.barchart.pr":              "交付",
